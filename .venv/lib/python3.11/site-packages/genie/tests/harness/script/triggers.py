...
class TriggerAetestRetry(Trigger):
    @aetest.test
    def test(self):
        pass

class TriggerRetry(Trigger):
    @aetest.test
    def test(self, uut, retry_count):
...
@aetest.retry(section_results=["passed"], retries=2, retry_wait=0)
class TriggerRetryOnPassed(Trigger):
    @aetest.test
    def test(self, uut):
        pass
