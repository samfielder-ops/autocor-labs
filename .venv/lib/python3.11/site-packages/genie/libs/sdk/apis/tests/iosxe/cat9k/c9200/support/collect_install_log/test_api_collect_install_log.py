...
from genie.libs.sdk.apis.iosxe.cat9k.c9200.support.tech_support import collect_install_log


class TestCollectInstallLog(unittest.TestCase):

    @patch('genie.libs.sdk.apis.iosxe.cat9k.c9200.support.tech_support.log')
    @patch('genie.libs.sdk.apis.iosxe.cat9k.c9200.support.tech_support.get_default_dir')
    @patch('genie.libs.sdk.apis.iosxe.cat9k.c9200.support.tech_support.datetime')
    def test_collect_install_log_success(self, mock_datetime, mock_get_default_dir, mock_log):
        ...
        with patch.object(type(runtime), 'directory', new_callable=PropertyMock) as mock_dir:
            ...
            with patch('re.search') as mock_search:
                ...
                device.execute.assert_any_call(
                    "show tech-support install | append show_tech_support_20250101T000000.txt",
                    timeout=600)
                device.execute.assert_any_call("request platform software trace archive")
                device.api.copy_from_device.assert_any_call(
                    local_path="flash:show_tech_support_20250101T000000.txt",
                    remote_path="/tmp")
                device.api.copy_from_device.assert_any_call(
                    local_path="flash:archive.tar.gz",
                    remote_path="/tmp")
