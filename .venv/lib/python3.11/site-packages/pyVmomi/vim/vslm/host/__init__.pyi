...
class VStorageObjectManager(VStorageObjectManagerBase):
   ...
   def RegisterDisk(self, path: str, name: Optional[str], modifyControlFlags: Optional[bool], id: Optional[ID]) -> VStorageObject: ...
   ...
   def RenameVStorageObject(self, id: ID, datastore: Datastore, name: str) -> None: ...
   def RetrieveVStorageInfrastructureObjectPolicy(self, datastore: Datastore) -> list[InfrastructureObjectPolicy]: ...
   def DeleteVStorageObject(self, id: ID, datastore: Datastore, isLcParentAttached: Optional[bool]) -> Task: ...
   ...
   def RelocateVStorageObject(self, id: ID, datastore: Datastore, spec: RelocateSpec, isLcParentAttached: Optional[bool]) -> Task: ...
   def SetVStorageObjectControlFlags(self, id: ID, datastore: Datastore, controlFlags: list[str]) -> None: ...
   def ClearVStorageObjectControlFlags(self, id: ID, datastore: Datastore, controlFlags: list[str]) -> None: ...
   def ReconcileDatastoreInventory(self, datastore: Datastore, deepCleansing: Optional[bool]) -> Task: ...
   def ScheduleReconcileDatastoreInventory(self, datastore: Datastore, deepCleansing: Optional[bool]) -> None: ...
   ...
   def CreateDiskFromSnapshot(self, id: ID, datastore: Datastore, snapshotId: ID, name: str, profile: list[ProfileSpec], crypto: Optional[CryptoSpec], path: Optional[str], provisioningType: Optional[str], isLinkedClone: Optional[bool], targetId: Optional[ID], targetDatastore: Optional[Datastore]) -> Task: ...
   ...
   def DeleteVStorageObjectEx(self, id: ID, datastore: Datastore, isLcParentAttached: Optional[bool]) -> Task: ...
