...
class VStorageObjectManager(VStorageObjectManagerBase):
   ...
   def RegisterDisk(self, path: str, name: Optional[str], id: Optional[ID]) -> VStorageObject: ...
   ...
   def CreateDiskFromSnapshot(self, id: ID, datastore: Datastore, snapshotId: ID, name: str, profile: list[ProfileSpec], crypto: Optional[CryptoSpec], path: Optional[str], isLinkedClone: Optional[bool], targetId: Optional[ID], targetDatastore: Optional[Datastore]) -> Task: ...
