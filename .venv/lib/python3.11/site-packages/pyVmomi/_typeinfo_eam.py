...
CreateEnumType("eam.lccm.Solutions.InvalidReason", "SolutionsInvalidReason", "eam.version.version1", ["INVALID_OVF_DESCRIPTOR", "INACCESSBLE_VM_SOURCE", "INVALID_NETWORKS", "INVALID_DATASTORES", "INVALID_RESOURCE_POOL", "INVALID_FOLDER", "INVALID_PROPERTIES", "INVALID_TRANSITION", "INVALID_CLUSTER_TRANSITION"])
...
CreateEnumType("eam.lccm.Solutions.NonComplianceReason", "SolutionsNonComplianceReason", "eam.version.version1", ["WORKING", "ISSUE", "IN_HOOK", "BLOCKED", "OBSOLETE_SPEC", "NO_SPEC"])
CreateDataType("eam.lccm.Solutions.HookInfo", "SolutionsHookInfo", "vmodl.DynamicData", "eam.version.version1", [("vm", "vim.VirtualMachine", "eam.version.version1", 0), ("solution", "string", "eam.version.version1", 0), ("config", "eam.lccm.Solutions.HookConfig", "eam.version.version1", 0), ("raisedAt", "vmodl.DateTime", "eam.version.version1", 0), ("dynamicUpdateProcessed", "boolean", "eam.version.version1", 0)])
